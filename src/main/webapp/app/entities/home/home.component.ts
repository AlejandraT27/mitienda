...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.homeService
      ...
      .subscribe(
        (res: HttpResponse<IHome[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IHome): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInHomes(): void {
    this.eventSubscriber = this.eventManager.subscribe('homeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IHome[] | null, headers: HttpHeaders, page: number): void {
